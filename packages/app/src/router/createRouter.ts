...
export interface Route {
  path?: string
  exact?: boolean
  component: Resource<ComponentType<any>>
...
export interface Router {
  ...
  subscribe: (listener: (nextEntry: Entry) => void) => () => void
}
  ...
  return {
    ...
    context: {
      ...
      preloadCode(pathname) {
        ...
        const matches: { route: Route }[] = matchRoutes(
          routes as any,
          pathname,
        ) as any
 ...
 */
function prepareMatches(matches: any): Match[] {
